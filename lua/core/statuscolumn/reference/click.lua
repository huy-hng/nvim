...
local function foldclose_click(args) fold_click(args, true) end

--- Handler for clicking '-' in fold column.
local function foldopen_click(args) fold_click(args, false) end

--- Handler for clicking ' ' in fold column.
local function foldempty_click(args) fold_click(args, false, true) end
