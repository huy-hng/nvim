...
function M.config()
	...
	Map.n('<leader><leader>s', loaders.edit_snippet_files, '[Snippet] edit snippet files')
	...
	ls.config.set_config {
		...
		ext_opts = require('plugins.editing.snippets.highlights'),
		ext_base_prio = 200,
		ext_prio_increase = 9,
	...
	require('luasnip.loaders.from_lua').load { paths = './lua/plugins/editing/snippets/ft' }
end
