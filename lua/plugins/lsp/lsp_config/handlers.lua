...
local function set_hover_handler()
	handler('textDocument/hover', function(_, result, ctx, lsp_config)
		...
		require('plugins.lsp.lsp_config.functions').close_with_esc(winnr)
...
vim.lsp.handlers['window/showMessage'] = require('plugins.lsp.lsp_config.show_message')
