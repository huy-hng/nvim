" from https://betterprogramming.pub/how-to-show-an-ascii-art-welcome-screen-at-the-top-of-the-vim-terminal-b8787f6ea9f4
...
" let g:startify_custom_header =
" 		\ startify#pad(split(system('figlet -n alskdj | cowsay'), '\n'))
...
let g:startify_custom_header =
	...
	\ startify#center(
		\ g:thought +
		\ g:asciis[ Get_random_offset(len(g:asciis)) ])
		" \ g:asciis[-1])
"
" let g:startify_custom_header =
" 	\ 'startify#center(startify#fortune#boxed()) + startify#center(g:thought + g:asciis[Get_random_offset(len(g:asciis))])'

" let g:startify_custom_footer = '"woah"'
