...
nmap('<C-{>', { functions.change_window_opacity, -0.1 }, 'Decrease window opacity')
nmap('<C-}>', { functions.change_window_opacity, 0.1 }, 'Increase window opacity')
nmap('<C-|>', function()os_fn.enable_blur_on_kde(not g.neovide_blur) end, 'Increase window opacity')
