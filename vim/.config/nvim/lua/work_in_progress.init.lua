...
vim.opt.clipboard = unnamedplus -- still needed?
...
vim.g.vimwiki_list = { {path = '~/personal/vimwiki', path_html = '~/personal/vimwiki/html/'}} 
vim.g.vimwiki_filetypes = {'markdown'}


function update_vimwiki (create)
	vim.g.vimwiki_create_link = create
    vim.call('vimwiki#vars#init')
end

function _G.create_link()
    update_vimwiki(1)
...
nmap('<A-CR>', ':call v:lua.create_link()<CR>')

function _G.super_tab()
    vim.cmd([[
...
imap('<Tab>', '<C-R>=v:lua.super_tab()<CR>')
